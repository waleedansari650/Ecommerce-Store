...
import { addProduct, updateProduct } from "../../services/producytServices";
import {useDispatch} from "react-redux";
const Model = ({ isModalOpen, closeModal, modelMode, setModalOpen }) => {
  useEffect(()=>{
    if(!isModalOpen){
      formik.resetForm();
      setProductImage("");
      ...
      const formik = useFormik({
        ...
        onSubmit: async (values) => {
          ...
          if (modelMode === "add") {
            ...
            console.log("response : ", productPromise)
            ...
            productPromise = await updateProduct(values);
          }
        },
      });
  ...
  return (
    ...
    <ThemeProvider theme={defaultTheme}>
      ...
      >
        ...
        >
          <h2 style={{ textAlign: "center" }}>{modelMode === "update" ? "Update Product" :  "ADD Product"}</h2>
