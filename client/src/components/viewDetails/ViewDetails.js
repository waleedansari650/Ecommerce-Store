...
<ListItem>
  ...
  >
    <span style={{marginLeft : "2rem"}}>{truncateDescription(item.productId.description)}</span>
  </Typography>
</ListItem>
                ...
                <CardContent>
                  ...
                  <List>
                    ...
                    <ListItem>
                      ...
                      <span style={{marginLeft : "4rem"}}>   {order?.address?.houseNo}, {order?.address?.street}{" "} {order?.address?.town}{" "}      {order?.address?.city}{" "} {order?.address?.province}</span>
